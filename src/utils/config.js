...
class Config {
    constructor() { 
        this.restServer = {};
        this.restServer.webSocketURL = "ws://218.50.103.173:13000";
        this.restServer.httpURL = "http://218.50.103.173:13000/api";
        this.restServer.explorer = "http://218.50.103.173:13000/explorer"; 

        this.playground = {};
        this.playground.name = "Hyperledger Composer";
        this.playground.docURL = "https://hyperledger.github.io/composer/latest/";
        this.playground.deployedURL = "http://218.50.103.173:18080";
